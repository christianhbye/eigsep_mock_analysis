...
## [0.2.0](https://github.com/christianhbye/eigsep_mock_analysis/compare/eigsim-v0.1.0...eigsim-v0.2.0) (2026-09-17)


### ⚠ BREAKING CHANGES

* **eigsim:** the default config's beam file and frequency grid change. `eigsep` now names eigsep_bowtie_v002_mwss.npz on 50.78125-250.0 MHz, and `eigsep_1mhz` names the v002 spline on 51-250 MHz. Pin `eigsep_v001` or `eigsep_v001_1mhz` (both frozen) to reproduce studies made with v001. `eigsep_v000` is untouched, so horizon_position and horizon_chromaticity, which pin it, are unaffected.
...
* **eigsim:** bowtie beam v002 from the native HFSS export ([e6fd5a5](https://github.com/christianhbye/eigsep_mock_analysis/commit/e6fd5a5405010eb6529e77a1880d337cee997633))
